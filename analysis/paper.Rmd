...
To prepare data for plotting, we created three functions with R code provided by the authors to estimate U5M by indirect method, Ward-Zaba model and our best-performing model respectively. These three functions were then further integrated into a function called plot_fig to create our replicated figures.
...
best_model <- function(iep, fig_name, best.fitting.model, full.model.formula){
...
plot_fig <- function(fig_name, fig_country){
  ...
  prediction <- best_model(iep, fig_name, best.fitting.model, full.model.formula)
