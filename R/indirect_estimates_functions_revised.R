...
ind_est_computations_core <- function(surv_moms,survey){
  ...
  #Parity ratios
  p1520 = byagegroup[byagegroup$agegroup=='[15,20)',"ceb"]/byagegroup[byagegroup$agegroup=='[20,25)',"ceb"]
  p2025 = byagegroup[byagegroup$agegroup=='[20,25)',"ceb"]/byagegroup[byagegroup$agegroup=='[25,30)',"ceb"]
